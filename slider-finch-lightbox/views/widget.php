...
<!--
                ...
                <div class="uk-panel uk-overlay uk-overlay-hover uk-cover-background uk-margin-top-remove" <?php echo $media; ?>>
                    ...
                    <!-- Replaced code -->
                    <a class="uk-position-cover" title="<?php echo htmlspecialchars($item['title']);?>" data-lightbox-type="image" data-uk-lightbox="{group:'<?php echo $groupcode;?>'}" href="<?php echo $item->get('media'); ?>"<?php echo $link_target; ?>></a>
<!--
